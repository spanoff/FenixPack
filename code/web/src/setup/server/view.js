...
<head>
    ...
    <meta name="theme-color" content="#e5ae49">
    ${helmet ? helmet.title.toString() + " " + helmet.meta.toString() : ""}
  
    <link rel="manifest" href="/manifest.json">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="#e5ae49">
    <meta name="apple-mobile-web-app-title" content="Crate">
    <meta name="msapplication-TileColor" content="#b54f38">
...
<body>
    ...
    <script type="text/javascript" src="${APP_URL}/js/bundles/app.js${
    NODE_ENV !== "production" ? "?" + Math.random() : ""
  }"></script>
    <script>
