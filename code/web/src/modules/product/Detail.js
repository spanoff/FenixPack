...
class Detail extends PureComponent {
  ...
  render() {
    ...
    return <div>
        {!error ? isLoading ? <Loading /> : renderIf(
              item && item.id,
              () => (
                <div>
                  {/* SEO */}
                  ...
                  >
                    ...
                    <GridCell style={{ textAlign: "center" }}>
                      ...
                      <p style={{ marginTop: "0.5em", color: grey2 }}>
                        Запущен {new Date(item.createdAt).toDateString()}
                      </p>
                    </GridCell>
                  </Grid>
                  ...
                  <Grid style={{ backgroundColor: grey }}>
                    <GridCell
                      style={{ padding: "2em", textAlign: "center" }}
                    >
                      <H3 font="secondary">Сопутствующие товары</H3>
                    </GridCell>
                  </Grid>
