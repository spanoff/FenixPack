      ...
      <View style={styles.container}>
        ...
        <Touchable onPress={() => this.navigate(routes.home.name)}>
          <View style={styles.item}>
            ...
            <Text style={[styles.itemTitle, { color: this.active(routes.home.name) }]}>Главная</Text>
          </View>
        </Touchable>
        ...
        <Touchable onPress={() => this.navigate(routes.crates.name)}>
          <View style={styles.item}>
            ...
            <Text style={[styles.itemTitle, { color: this.active(routes.crates.name) }]}>Пакеты</Text>
          </View>
        </Touchable>
        ...
        <Touchable onPress={() => this.navigate(routes.whatsNew.name)}>
          <View style={styles.item}>
            ...
            <Text style={[styles.itemTitle, { color: this.active(routes.whatsNew.name) }]}>Новинки</Text>
          </View>
        </Touchable>
        ...
        <Touchable onPress={() => this.navigate(routes.account.name)}>
          <View style={styles.item}>
            ...
            <Text style={[styles.itemTitle, { color: this.active(routes.account.name) }]}>Профиль</Text>
          </View>
        </Touchable>
      </View>
    )
